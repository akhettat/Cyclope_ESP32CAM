...
base_photos_dir = "C:/Users/sebas/OneDrive/Documents/Cours/ProjetCyclope"
current_photos_dir = base_photos_dir
os.makedirs(base_photos_dir, exist_ok=True)

esp32_cam_url = "http://192.168.1.39/capture"
...
def create_new_photo_folder():
    ...
    try:
        ...
        logging.error(f"Error resetting Excel file: {e}")
        return str(e), 500
